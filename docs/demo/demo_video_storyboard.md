...
Output: `docs/demo/replocx-demo.webm`

This is a public-safe, captioned product-demo trailer for ReplocX using the
synthetic demonstration dataset. It is designed for portfolio review, academic
collaborator demos, and private pull-request review.
