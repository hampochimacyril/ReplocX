#!/usr/bin/env python3
"""Render a polished animated MP4 promo for ReplocX.
...
def s_title(t):
    ...
    dy,_=rise(t,d=0.2); text(dr,(W/2,H*0.74+dy),"ReplocX",SERIF(78),INK,alpha=a)
...
def s_cta(t):
    ...
    dy,_=rise(t,d=0.2); text(dr,(cx,H*0.55+dy),"ReplocX",SERIF(60),INK,alpha=a)
...
def main():
    ...
    try:
        ...
        pass  # some synced filesystems block unlink; harmless
